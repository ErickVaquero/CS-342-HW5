...
public class GUI_2 implements UserInterface
{
	...
	private Vector<JToolTip> placeCharTip, placeItemTip, inveTip;
	...
	public GUI_2(Character c)
	{
		...
		placeInfoPanel = new JPanel(new GridLayout(2,1));
		...
		column3.add(output, BorderLayout.SOUTH);
